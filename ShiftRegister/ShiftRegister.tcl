# 
# Project automation script for ShiftRegister 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source ShiftRegister.tcl), then you can
...
set myProject "ShiftRegister"
set myScript "ShiftRegister.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ClockBaseTop.v"
   xfile add "ClockDivider.v"
   xfile add "SRtest.v"
   xfile add "ShiftRegTestbench.v"
   xfile add "ShiftRegTop.v"
   xfile add "pins.ucf"

   # Set the Top Module as well...
   project set top "ClockBaseTop"
...
proc set_process_props {} {
   ...
   project set "Project Description" "simple 8bit shiftreg"
   ...
   project set "Target UCF File Name" "C:/Users/Crazyfingers/Documents/Atlys Projects/ShiftRegister/VHDCI_constraints.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "C:/Users/Crazyfingers/Documents/Atlys Projects/ShiftRegister/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "ClockBaseTop" -process "Generate IBIS Model"
